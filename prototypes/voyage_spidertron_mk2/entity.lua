...
local voyage_spidertron_mk2_animations =
	require("__spidertrontiers-community-updates__.spidertron_animations.voyage_spidertron_mk2-animations")
...
local voyage_spidertron_mk2 = {
	...
	minimap_representation = {
		filename = "__spidertrontiers-community-updates__/graphics/entity/voyage_spidertron_mk2/spidertron-map.png",
		flags = { "icon" },
		size = { 128, 128 },
		scale = 0.5,
	},
...
local voyage_spidertron_mk2_remnants = {
	...
	animation = make_rotated_animation_variations_from_sheet(1, {
		layers = {
			{
				filename = "__spidertrontiers-community-updates__/graphics/entity/voyage_spidertron_mk2/remnants/spidertron-remnants.png",
				line_length = 1,
				width = 224,
				height = 224,
				frame_count = 1,
				...
				r_version = {
					filename = "__spidertrontiers-community-updates__/graphics/entity/voyage_spidertron_mk2/remnants/hr-spidertron-remnants.png",
					line_length = 1,
					width = 448,
					height = 448,
					frame_count = 1,
			...
			{
				priority = "low",
				filename = "__spidertrontiers-community-updates__/graphics/entity/voyage_spidertron_mk2/remnants/mask/spidertron-remnants-mask.png",
				width = 184,
				height = 176,
				frame_count = 1,
				...
				hr_version = {
					priority = "low",
					filename = "__spidertrontiers-community-updates__/graphics/entity/voyage_spidertron_mk2/remnants/mask/hr-spidertron-remnants-mask.png",
					width = 366,
					height = 350,
					frame_count = 1,
					--tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 },
...
require("lib/fuel").addEnergySource(voyage_spidertron_mk2, 150, 3)
...
for i = 1, 10 do
	data:extend({
		utils.make_spidertron_leg(
			"voyage-spidertron-mk2",
			1,
			0.06,
			0.03,
			i,
			voyage_spidertron_mk2_animations,
			{ knee_height = 2.5 }
		),
	})
end
