...
local bulwark_spidertron_mk1_animations =
	require("__spidertrontiers-community-updates__.spidertron_animations.bulwark_spidertron_mk1-animations")
...
for i = 1, 8 do
	data:extend({
		utils.make_spidertron_leg(
			"bulwark-spidertron-mk1",
			0.6,
			0.06,
			0.015,
			i,
			bulwark_spidertron_mk1_animations,
			{ knee_height = 1.5 }
		),
	})
end
